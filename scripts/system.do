...
add wave -noupdate -expand -group {Program Counter} -radix decimal /system_tb/DUT/CPU/DP/pcif/next_count
...
add wave -noupdate -expand -group ifid /system_tb/DUT/CPU/DP/ifidif/pcplus4_in
add wave -noupdate -expand -group ifid /system_tb/DUT/CPU/DP/ifidif/pcplus4_out
add wave -noupdate -expand -group ifid /system_tb/DUT/CPU/DP/ifidif/flush
add wave -noupdate -expand -group ifid /system_tb/DUT/CPU/DP/ifidif/writeEN
add wave -noupdate -expand -group ifid -radix binary /system_tb/DUT/CPU/DP/ifidif/instr_in
add wave -noupdate -expand -group ifid /system_tb/DUT/CPU/DP/ifidif/instr_out
add wave -noupdate -expand -group idex /system_tb/DUT/CPU/DP/idexif/pcplus4_in
add wave -noupdate -expand -group idex /system_tb/DUT/CPU/DP/idexif/rdat1_in
add wave -noupdate -expand -group idex /system_tb/DUT/CPU/DP/idexif/rdat2_in
add wave -noupdate -expand -group idex /system_tb/DUT/CPU/DP/idexif/immext_in
add wave -noupdate -expand -group idex /system_tb/DUT/CPU/DP/idexif/rt_in
add wave -noupdate -expand -group idex /system_tb/DUT/CPU/DP/idexif/rd_in
add wave -noupdate -expand -group idex /system_tb/DUT/CPU/DP/idexif/AluOp_in
add wave -noupdate -expand -group idex /system_tb/DUT/CPU/DP/idexif/MemToReg_in
add wave -noupdate -expand -group idex /system_tb/DUT/CPU/DP/idexif/AluSrc_in
add wave -noupdate -expand -group idex /system_tb/DUT/CPU/DP/idexif/JType_in
add wave -noupdate -expand -group idex /system_tb/DUT/CPU/DP/idexif/RegDst_in
add wave -noupdate -expand -group idex /system_tb/DUT/CPU/DP/idexif/regWEN_in
add wave -noupdate -expand -group idex /system_tb/DUT/CPU/DP/idexif/PcSrc_in
add wave -noupdate -expand -group idex /system_tb/DUT/CPU/DP/idexif/JReg_in
add wave -noupdate -expand -group idex /system_tb/DUT/CPU/DP/idexif/Halt_in
add wave -noupdate -expand -group idex /system_tb/DUT/CPU/DP/idexif/writeEN
add wave -noupdate -expand -group idex /system_tb/DUT/CPU/DP/idexif/flush
add wave -noupdate -expand -group idex /system_tb/DUT/CPU/DP/idexif/dMemWEN_in
add wave -noupdate -expand -group idex /system_tb/DUT/CPU/DP/idexif/dMemREN_in
add wave -noupdate -expand -group idex /system_tb/DUT/CPU/DP/idexif/pcplus4_out
add wave -noupdate -expand -group idex -radix decimal /system_tb/DUT/CPU/DP/idexif/rdat1_out
add wave -noupdate -expand -group idex -radix decimal /system_tb/DUT/CPU/DP/idexif/rdat2_out
add wave -noupdate -expand -group idex -radix decimal /system_tb/DUT/CPU/DP/idexif/immext_out
add wave -noupdate -expand -group idex /system_tb/DUT/CPU/DP/idexif/rt_out
add wave -noupdate -expand -group idex /system_tb/DUT/CPU/DP/idexif/rd_out
add wave -noupdate -expand -group idex /system_tb/DUT/CPU/DP/idexif/AluOp_out
add wave -noupdate -expand -group idex /system_tb/DUT/CPU/DP/idexif/MemToReg_out
add wave -noupdate -expand -group idex /system_tb/DUT/CPU/DP/idexif/AluSrc_out
add wave -noupdate -expand -group idex /system_tb/DUT/CPU/DP/idexif/JType_out
add wave -noupdate -expand -group idex /system_tb/DUT/CPU/DP/idexif/RegDst_out
add wave -noupdate -expand -group idex /system_tb/DUT/CPU/DP/idexif/regWEN_out
add wave -noupdate -expand -group idex /system_tb/DUT/CPU/DP/idexif/PcSrc_out
add wave -noupdate -expand -group idex /system_tb/DUT/CPU/DP/idexif/JReg_out
add wave -noupdate -expand -group idex /system_tb/DUT/CPU/DP/idexif/Halt_out
add wave -noupdate -expand -group idex /system_tb/DUT/CPU/DP/idexif/dMemWEN_out
add wave -noupdate -expand -group idex /system_tb/DUT/CPU/DP/idexif/dMemREN_out
...
add wave -noupdate -radix binary /system_tb/DUT/CPU/DP/hazardif/instrOp
...
update
WaveRestoreZoom {342707 ps} {1034595 ps}
