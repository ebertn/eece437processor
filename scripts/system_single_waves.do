...
add wave -noupdate -group {Instruction IF} -label jt /system_tb/DUT/CPU/DP0/jt_if
add wave -noupdate -group {Instruction IF} -label it /system_tb/DUT/CPU/DP0/it_if
add wave -noupdate -group {Instruction IF} -label rt /system_tb/DUT/CPU/DP0/rt_if
...
TreeUpdate [SetDefaultTree]
WaveRestoreCursors {{Cursor 1} {347585265 ps} 0}
